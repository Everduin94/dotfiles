local M = {}
M.term = function(list_item, list, options)
...
M.setup_dynamic_switcher_keymaps = function()
  ...
  -- Types
  map("n", "<leader>orm", find(".+model.ts|.+models.ts|.+types.ts", { regex = true }), { desc = "Go to Models" })
