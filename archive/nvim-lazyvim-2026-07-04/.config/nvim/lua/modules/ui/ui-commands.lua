...
-- Markview heading overrides (cool catppuccin mocha tones instead of red/orange/yellow)
vim.api.nvim_set_hl(0, "MarkviewHeading1", { fg = "#89b4fa", bg = "#1e2738" })     -- blue
vim.api.nvim_set_hl(0, "MarkviewHeading1Sign", { fg = "#89b4fa" })
vim.api.nvim_set_hl(0, "MarkviewHeading2", { fg = "#94e2d5", bg = "#1e2e30" })     -- teal
vim.api.nvim_set_hl(0, "MarkviewHeading2Sign", { fg = "#94e2d5" })
vim.api.nvim_set_hl(0, "MarkviewHeading3", { fg = "#cba6f7", bg = "#272138" })     -- mauve
vim.api.nvim_set_hl(0, "MarkviewHeading3Sign", { fg = "#cba6f7" })
vim.api.nvim_set_hl(0, "MarkviewHeading4", { fg = "#74c7ec", bg = "#1e2a35" })     -- sapphire
vim.api.nvim_set_hl(0, "MarkviewHeading4Sign", { fg = "#74c7ec" })
vim.api.nvim_set_hl(0, "MarkviewHeading5", { fg = "#94e2d5", bg = "#1e2e30" })     -- teal
vim.api.nvim_set_hl(0, "MarkviewHeading5Sign", { fg = "#94e2d5" })
vim.api.nvim_set_hl(0, "MarkviewHeading6", { fg = "#b4befe", bg = "#242438" })     -- lavender
vim.api.nvim_set_hl(0, "MarkviewHeading6Sign", { fg = "#b4befe" })

vim.api.nvim_set_hl(0, "MarkviewListItemMinus", { fg = "#89b4fa" })   -- blue
vim.api.nvim_set_hl(0, "MarkviewListItemPlus", { fg = "#89b4fa" })   -- blue
vim.api.nvim_set_hl(0, "MarkviewListItemStar", { fg = "#89b4fa" })   -- blue

vim.api.nvim_set_hl(0, "MarkviewBlockQuoteDefault", { fg = "#cdd6f4" })  -- text
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteError", { fg = "#cdd6f4" })    -- text
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteNote", { fg = "#cdd6f4" })     -- text
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteSpecial", { fg = "#cdd6f4" })  -- text
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteWarn", { fg = "#cdd6f4" })     -- text
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteOk", { fg = "#cdd6f4" })       -- text
