...
-- TODO: 2 feels huge, but maybe 1.5 is not ideal because of zoom factor
local browser      = "google-chrome-stable --force-device-scale-factor=1.5"
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift"   }, "g", function () awful.layout.inc(-1)                end,
...
clientkeys = mytable.join(
    ...
    awful.key({ modkey,           }, "p",      function (c) c.sticky = not c.sticky end,
              {description="Pin to top", group="awesome"}),
    awful.key({ modkey,           }, "n",
        function (c)
