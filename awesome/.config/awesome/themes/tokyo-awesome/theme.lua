...
theme.taglist_fg_focus                          = tokyoNight.normal.blue
theme.taglist_bg_focus                          = tokyoNight.normal.black
...
theme.border_focus                              = tokyoNight.normal.black
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, tokyoNight.normal.green),
            pl(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, tokyoNight.normal.teal),
            pl(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal },tokyoNight.normal.cyan),
            --pl(wibox.widget { fsicon, theme.fs and theme.fs.widget, layout = wibox.layout.align.horizontal }, "#CB755B"),
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, tokyoNight.normal.blue),
            pl(wibox.widget { neticon, net.widget, layout = wibox.layout.align.horizontal }, tokyoNight.normal.magenta),
            pl(clock, tokyoNight.normal.red),
            --[[
            -- using separators
