...
![screenshot](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-documents.png)
...
![screenshot](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-code.png)
...
![dictionary](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-context-menu.png)
...
![dictionary](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-dictionary.png)

It can be reached by clicking on indicator field with an "eye" symbol in status bar:

![switch](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-switch-on.png)
...
![switch](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-switch-off.png)

Or when it has been forced OFF by In-Document command (`spellcheck&#x2d;off`) or rule in `.spellignore`:

![switch](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-switch-forced-off.png)
...
![switch](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-switch-multiple.png)

And when at least one language spelled is missing dictionary:

![switch](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-switch-multiple-missing.png)
...
![dictionary](https://github.com/bartosz-antosik/vscode-spellright/raw/HEAD/media/screenshot-parser.png)
...
[Changelog](https://github.com/bartosz-antosik/vscode-spellright/blob/HEAD/CHANGELOG.md)
