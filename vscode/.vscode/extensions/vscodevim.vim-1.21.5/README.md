...
- 📃 Our [change log](https://github.com/VSCodeVim/Vim/blob/HEAD/CHANGELOG.md) outlines the breaking/major/minor updates between releases.
...
This project is maintained by a group of awesome [people](https://github.com/VSCodeVim/Vim/graphs/contributors) and contributions are extremely welcome :heart:. For a quick tutorial on how you can help, see our [contributing guide](https://github.com/VSCodeVim/Vim/blob/HEAD/.github/CONTRIBUTING.md).
