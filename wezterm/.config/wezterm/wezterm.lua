...
wezterm.on('toggle-highlight', function(window, pane)
  ...
  if not overrides.window_background_opacity then
    overrides.window_background_opacity = .88
  elseif overrides.window_background_opacity == .88 then
    overrides.window_background_opacity = .82
  elseif overrides.window_background_opacity == .82 then
